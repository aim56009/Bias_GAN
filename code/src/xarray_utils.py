...
def sync(dataset_1: xr.Dataset, dataset_2: xr.Dataset) -> (xr.Dataset, xr.Dataset):
...
def select_times(dataset: xr.Dataset, reference_time: list) -> (xr.Dataset, xr.Dataset):
...
def regrid(ds: xr.Dataset, lats: list, lons: list, target_resolution=None, method='bilinear', periodic=False) -> xr.Dataset:
    import xesmf as xe
    """
